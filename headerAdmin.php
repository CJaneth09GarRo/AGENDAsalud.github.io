        ...
        <nav class="nav">
            <div> <a href="inicio.php" class="nav_logo"> <i class='bx bx-plus-medical nav_logo-icon'></i> <span class="nav_logo-name">Clínica Sevilla</span> </a>
                <div class="nav_list">
                    ...
                    <a href="usuarios.php" class="nav_link"> <i class='bx bx-user nav_icon'></i><span class="nav_name">Usuarios</span></a>
                    <a href="citas.php" class="nav_link"> <i class='bx bx-calendar nav_icon'></i><span class="nav_name">Citas</span></a>
                    <a href="Agendar.php" class="nav_link"> <i class='bx bx-comment-add nav_icon'></i><span class="nav_name">Nueva cita</span></a>
                </div>
            </div>
            <a href="#" class="nav_link" data-bs-toggle="modal" data-bs-target="#cerrarModal"> <i class='bx bx-log-out nav_icon'></i> <span class="nav_name">Cerrar sesion</span> </a>
        </nav>
    </div>
