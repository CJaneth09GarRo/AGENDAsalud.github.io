...
$paciente = $db->getIdPaciente($_SESSION['Usuario']);
$_SESSION['Paciente'] = $paciente['idpacientes'];
$citas = $db->getCitas($_SESSION['Paciente']);
...
<div class="height-100 bg-light">
    ...
    <br>
    <div class="container">
        <h1 class="mt-4">Citas agendadas</h1>
        <br>
        <table class="table table-bordered border border-danger" id="Mitabla">
            <thead>
                ...
                <?php foreach ($citas as $cita) : ?>
                    <tr>
                        ...
                        <td class="col-1">
                            ...
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $cita['N_Cita'] ?>"><a>
...
<script>
    ...
    deleteModal.addEventListener('show.bs.modal', function(event) {
        ...
        confirmDelete.href = '../bd/eliminar.php?id=' + Id +'&pag=3'
    })
</script>
